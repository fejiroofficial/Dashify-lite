     ...
     <section className="hero container mx-auto relative flex flex-col items-center justify-center text-center w-full lg:mb-8 px-4 pb-8 lg:pb-16">
       <div className="relative z-10 items-center">
         ...
         <Image
               src={Bg}
               alt="bg-icon"
               className="absolute top-[-2rem] right-[2.6rem] hidden lg:block"
             />
           ...
           <div className="flex flex-col gap-4 pb-6 justify-end items-end text-[#545454] ">
             ...
             <button className="bg-black text-white w-full md:w-[408px] md:h-[63px] rounded-lg text-[18px]">
               ...
               <span className="text-[12px]">Fre ebook inclusive</span>{" "}
             </button>
           </div>
           <Image src={bolt} alt="thunder-bolt-icon" className="absolute right-6 md:right-[5rem] lg:right-[8rem] bottom-[30%] lg:bottom-[40%]" />
         </div>
         </div>
